...
void reboot_menu()
{
	...
	#define ITEM_BACKK		 4
    	...
    	static char* MENU_REBOOT_HEADERS[] = { "Reboot",
                                               NULL };
    
	// REBOOT MENU
	char* MENU_REBOOT[] = { "To System",
	                        "To Recovery",
	                        "To Bootloader",
	                        "Shut Down",
...
{
	char* tmp_set = (char*)malloc(40);
	strcpy(tmp_set, "[ ] Toggle Recovery Message Spam");
...
void all_settings_menu(int pIdx)
{
	...
	#define ALLS_MENU_BACK            7
    	...
    	static char* MENU_ALLS_HEADERS[] = { "Change Recovery Settings",
                                             NULL };
